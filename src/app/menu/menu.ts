...
//? DOC: http://localhost:7777/demo/umanager-angular-admin-dashboard-template/documentation/guide/development/navigation-menus.html#interface
...
export const menu: CoreMenu[] = [
  ...
  // Apps & Pages
  {
    ...
    children: [
            ...
            children: [
              {
                ...
                type: 'item',
                url: 'https://pixinvent.com/demo/umanager-mail-template/mail-welcome.html',
                externalUrl: true,
                openInNewTab: true
              },
              {
                ...
                type: 'item',
                url: 'https://pixinvent.com/demo/umanager-mail-template/mail-reset-password.html',
                externalUrl: true,
                openInNewTab: true
              },
              {
                ...
                type: 'item',
                url: 'https://pixinvent.com/demo/umanager-mail-template/mail-verify-email.html',
                externalUrl: true,
                openInNewTab: true
              },
              {
                ...
                type: 'item',
                url: 'https://pixinvent.com/demo/umanager-mail-template/mail-deactivate-account.html',
                externalUrl: true,
                openInNewTab: true
              },
              {
                ...
                type: 'item',
                url: 'https://pixinvent.com/demo/umanager-mail-template/mail-invoice.html',
                externalUrl: true,
                openInNewTab: true
              },
              {
                ...
                type: 'item',
                url: 'https://pixinvent.com/demo/umanager-mail-template/mail-promotional.html',
                externalUrl: true,
                openInNewTab: true
              }
            ]
      ...
      },
      {
        id: 'project',
        title: 'Projects',
        translate: 'MENU.APPS.PROJECT.COLLAPSIBLE',
        type: 'collapsible',
        icon: 'user',
        children: [
          {
            id: 'list',
            title: 'List',
            translate: 'MENU.APPS.PROJECT.LIST',
            type: 'item',
            icon: 'circle',
          ...
          },
          {
            id: 'view',
            title: 'View',
            translate: 'MENU.APPS.PROJECT.VIEW',
            type: 'item',
            icon: 'circle',
            url: 'apps/project/project-view'
          },
          {
            id: 'edit',
            title: 'Edit',
            translate: 'MENU.APPS.PROJECT.EDIT',
            type: 'item',
            icon: 'circle',
            url: 'apps/project/project-edit'
          },
          {
            id: 'new',
            title: 'New',
            translate: 'MENU.APPS.PROJECT.NEW',
            type: 'item',
            icon: 'circle',
            url: 'apps/project/project-new'
          }
        ]
      }
    ]
  ...
  //       icon: 'file-text',
  //       type: 'item',
  //       url: 'https://pixinvent.com/demo/umanager-angular-admin-dashboard-template/documentation',
  //       externalUrl: true,
  //       openInNewTab: true
  //     },
  //     {
