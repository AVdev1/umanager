...
import {UserNewService} from "./user-new/user-new.service";
...
const routes: Routes = [
  ...
  },
  {
    ...
    data: { animation: 'UserNewComponent' }
  },
  // {
  //   path: 'user-view',
...
@NgModule({
  declarations: [UserListComponent, UserViewComponent, UserEditComponent, UserNewComponent, NewUserSidebarComponent],
  imports: [
    CommonModule,
  ...
  providers: [UserListService, UserViewService, UserEditService, UserNewService]
})
